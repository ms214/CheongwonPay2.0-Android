...
public class NetworkThread extends HandlerThread {
    ...
    public static final int OP_LOGIN = 1, OP_PURCHASE = 2, OP_ADD_ITEM = 3, OP_RF_BAL = 4, OP_GetGoodsList = 5,
            ...
            OP_BALANCE_CHARGE=16, OP_CHANGEINFO = 17, OP_CLUB_Profit = 18, OP_PAY_BACK = 19, OP_LOST_REPORT = 20,  OP_CANCEL_LOST = 21, OP_PURCHASE_RS_OverLimit = 104, OP_PURCHASE_RS_UserNull = 106, OP_PURCHASE_RS_Success = 105, OP_CHARGE_RS_USERNULL = 107, OP_CHARGE_RS_SUCCESS = 108,
...
//    boolean result = false;
    ...
    private void sendLostActivity(int OP_Code, String Data){
        Message msg = new Message();
        msg.what = OP_Code;
        msg.obj = Data;
        LostActivity.mhandler.sendMessage(msg);
    }
    private void sendLostCancelActivity(int OP_Code, String Data){
        Message msg = new Message();
        msg.what = OP_Code;
        msg.obj = Data;
        LostCancelActivity.mhandler.sendMessage(msg);
    }
                            ...
                            switch (msg.what) {// OP-Code에 따라 작동
                                ...
                                case 3000:
                                    try {
                                        ...
                                        dos.writeUTF((String) msg.obj);
                                        String readData = dis.readUTF();
                                        sendLostCancelActivity(OP_GetName, readData);
                                    } catch (IOException e) {
                                        e.printStackTrace();
                                        break;
                                    }
                                ...
                                case OP_LOST_REPORT:
                                    try {
                                        dos.writeInt(OP_LOST_REPORT);
                                        dos.writeUTF((String) msg.obj);
                                        int readData = dis.readInt();
                                        String readData2 = String.valueOf(readData);
                                        Log.e("readData", readData2);
                                        sendLostActivity(OP_LOST_REPORT, readData2);
                                    } catch (IOException e) {
                                        e.printStackTrace();
                                        quit();
                                        break;
